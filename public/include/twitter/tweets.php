...
if( isset( $_GET['username'] ) AND $_GET['username'] != '' ):
	...
	$apikey = ""; // Your Twitter/X API Key
	$apisecret = ""; // Your Twitter/X API Secret
	$accesstoken = ""; // Your Twitter/X Access Token
	$accesstokensecret = ""; // Your Twitter/X Access Token Secret
	$bearertoken = ""; // Your Twitter/X Bearer Token
